...
const UpdateItem = () => {
    ...
    return (
          <>
            ...
            <div className="inventoryItemBox max-w-[65rem] mx-auto py-7 sm:py-16 md:py-[10rem]">
                    ...
                    <div className='flex justify-between'>
                      ...
                      <div className=" w-[47%]">
                        <form onSubmit={addQuantity} className="flex justify-between" >
                          <input type="number" name="quantity" placeholder='Quantity' className='w-[55%] py-2 rounded-lg text-[#787878] pl-4 font-[500] text-2xl' />
